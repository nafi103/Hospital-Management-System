        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtRoom = table.Column<string>(type: "text", nullable: false),
                    OperationDatetime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PreparationChecklist = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountApprovedById = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bills_Users_DiscountApprovedById",
                        column: x => x.DiscountApprovedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                table: "Beds",
                columns: new[] { "Id", "BedNumber", "Category", "CreatedAt", "DailyRate", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "ICU-01", 0, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 5000m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, "WD-101", 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 1000m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, "CABIN-05", 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 3500m, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "All", "Admin", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Read, Write_Patient", "Doctor", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Read, Write_Admission", "Receptionist", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Category", "CreatedAt", "FullName", "Password", "RoleId", "UpdatedAt", "Username" },
                values: new object[] { 1, "Management", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System Admin", "admin123", 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_DiscountApprovedById",
                table: "Bills",
